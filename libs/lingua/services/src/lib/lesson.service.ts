...
export class LessonService {
  ...
  getLessonById(id: string): Observable<ILesson> {
    return this.http.get<ILesson>(
      `${environment.dataApiUrl}/lesson/${id}`,
      this.auth.getHttpOptions(),
    );
  }
  ...
  delete(id: Id) {
    return this.http.delete<ILesson>(
      `${environment.dataApiUrl}/lesson/${id}`,
      this.auth.getHttpOptions(),
    );
  }
  ...
  attend(lessonId: string) {
    return this.http.post<ILesson>(
      `${environment.dataApiUrl}/lesson/${lessonId}/attend`,
      {},
      this.auth.getHttpOptions(),
    );
  }
  ...
  unattend(lessonId: string) {
    return this.http.post<ILesson>(
      `${environment.dataApiUrl}/lesson/${lessonId}/unattend`,
      {},
      this.auth.getHttpOptions(),
    );
  }
