...
export class CourseService {
  ...
  getCourseById(id: string): Observable<ICourse> {
    return this.http.get<ICourse>(
      `${environment.dataApiUrl}/course/${id}`,
      this.auth.getHttpOptions(),
    );
  }
  ...
  assignTeacher(courseId: Id, teacherId: Id) {
    return this.http.put(
      `${environment.dataApiUrl}/course/${courseId}/assign`,
      { teacherId },
      this.auth.getHttpOptions(),
    );
  }
  ...
  removeTeacher(courseId: Id, teacherId: Id) {
    return this.http.put(
      `${environment.dataApiUrl}/course/${courseId}/remove`,
      { teacherId },
      this.auth.getHttpOptions(),
    );
  }
  ...
  postReview(courseId: Id, dto: CreateReviewDto) {
    return this.http.post(
      `${environment.dataApiUrl}/course/${courseId}/review`,
      dto,
      this.auth.getHttpOptions(),
    );
  }
  ...
  enroll(courseId: Id) {
    return this.http.post(
      `${environment.dataApiUrl}/course/${courseId}/enroll`,
      {},
      this.auth.getHttpOptions(),
    );
  }
  ...
  unenroll(courseId: Id) {
    return this.http.post(
      `${environment.dataApiUrl}/course/${courseId}/unenroll`,
      {},
      this.auth.getHttpOptions(),
    );
  }
  ...
  getRecomendations(userId: string) {
    return this.http.get<ICourse[]>(
      `${environment.rcmndApiUrl}/neo4j/user/${userId}/rcmnd`,
      this.auth.getHttpOptions(),
    );
  }
}
