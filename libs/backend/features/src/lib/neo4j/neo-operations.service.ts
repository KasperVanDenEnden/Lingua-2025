...
import {
  ...
  REL_ATTENDS_CYPHER,
  DETACH_LESSON_CYPHER,
  DETACH_COURSE_CYPHER,
  DETACH_USER_CYPHER,
  REL_UNENROLL_IN_CYPHER,
  REL_UNATTENDS_CYPHER,
  REL_TEACHING_CYPHER,
  REL_UNFOLLOW_CYPHER,
  DETACH_REVIEW_CYPHER,
} from '@lingua/api';
...
export class NeoOperationsService {
  ...
  async reviewCourse(
    ...
    await this.neo4j.run(REL_REVIEWED_CYPHER, {
      userId,
      courseId,
      id: reviewId,
      rating,
