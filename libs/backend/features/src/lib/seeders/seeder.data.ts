...
export const LESSON_SEED_DATA = [
    { title: 'Lesson 1', description: 'Introduction', day: new Date().setDate(new Date().getDate() + 8), startTime: new Date('2024-09-01T10:00:00'), endTime: new Date('2024-09-01T11:30:00'), status: LessonStatus.Open },
    { title: 'Lesson 2', description: 'Vocabulary & Grammar', day: new Date().setDate(new Date().getDate() + 9), startTime: new Date('2024-09-03T10:00:00'), endTime: new Date('2024-09-03T11:30:00'), status: LessonStatus.Open },
    { title: 'Lesson 3', description: 'Listening practice', day: new Date().setDate(new Date().getDate() + 10), startTime: new Date('2024-09-05T10:00:00'), endTime: new Date('2024-09-05T11:30:00'), status: LessonStatus.Open},
    { title: 'Lesson 4', description: 'Speaking Practice', day: new Date().setDate(new Date().getDate() + 11), startTime: new Date('2024-09-07T10:00:00'), endTime: new Date('2024-09-07T11:30:00'), status: LessonStatus.Open },
    { title: 'Lesson 5', description: 'Review and Assessment', day: new Date().setDate(new Date().getDate() + 12), startTime: new Date('2024-09-09T10:00:00'), endTime: new Date('2024-09-09T11:30:00'), status: LessonStatus.Open },
];
